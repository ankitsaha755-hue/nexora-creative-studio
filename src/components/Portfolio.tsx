...
const projects = [
  ...
  { tag: "Toolkit", title: "Business Toolkit Suite", desc: "A curated bundle of productivity systems — ready to download.", color: "from-cyan-400/30 to-violet-600/30", href: "/downloads" },
];
