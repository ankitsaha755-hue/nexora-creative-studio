...
const projects = [
  ...
  { tag: "Data", title: "Retail Insights Engine", desc: "Pipeline processing 12M records daily.", color: "from-cyan-400/30 to-violet-600/30", href: "/Nexus Pro.zip", external: true },
];
